...
GIT_INFO = {'remote': None, 'branch': None, 'commit': None}
...
def train(hyp, opt, device, callbacks):
    ...
    is_coco = False  # 직접 지정했으므로 COCO 아님
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=r"C:yaml path", help="dataset.yaml path")
    ...
    parser.add_argument("--project", default=ROOT / "C:Project path", help="save to project/name")
    parser.add_argument("--name", default="HPC", help="save to project/name")
